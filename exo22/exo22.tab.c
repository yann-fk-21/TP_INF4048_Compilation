...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_stat = 12,                      /* stat  */
  YYSYMBOL_bloc = 13,                      /* bloc  */
  YYSYMBOL_instr = 14,                     /* instr  */
  YYSYMBOL_E = 15,                         /* E  */
  YYSYMBOL_T = 16,                         /* T  */
  YYSYMBOL_F = 17                          /* F  */
};
...
static const char *const yytname[] =
{
  ...
  "VARIABLE", "';'", "'='", "'+'", "'*'", "$accept", "Program", "stat",
  "bloc", "instr", "E", "T", "F", YY_NULLPTR
};
...
#line 1093 "exo22.tab.c"
    break;

  case 6: /* instr: VARIABLE '=' E  */
#line 43 "exo22.y"
                     {affec(yyvsp[-2]); /* Réduction instr ---> var = E */}
#line 1099 "exo22.tab.c"
    break;

  case 7: /* instr: PRINT VARIABLE  */
#line 44 "exo22.y"
                      {take(yyvsp[0]); print(); /* Réduction instr ---> print: %d", take($2) */}
#line 1105 "exo22.tab.c"
    break;

  case 8: /* E: T  */
#line 48 "exo22.y"
    {printf("\nRéduction E ----> T    $$=%d",yyval); }
#line 1111 "exo22.tab.c"
    break;

  case 9: /* E: E '+' T  */
#line 49 "exo22.y"
             {add(); printf("\nRéduction E ----> E + T    "); }
#line 1117 "exo22.tab.c"
    break;

  case 11: /* T: T '*' F  */
#line 54 "exo22.y"
             {mult(); printf("\nRéduction T ----> T * F    "); }
#line 1123 "exo22.tab.c"
    break;

  case 12: /* F: INTEGER  */
#line 57 "exo22.y"
            {push(&p, yyvsp[0]);printf("\nRéduction F ----> int"); }
#line 1129 "exo22.tab.c"
    break;

  case 13: /* F: VARIABLE  */
#line 58 "exo22.y"
                {push(&p, take(yyvsp[0])); printf("\nRéduction F ----> var");}
#line 1135 "exo22.tab.c"
    break;


#line 1139 "exo22.tab.c"
